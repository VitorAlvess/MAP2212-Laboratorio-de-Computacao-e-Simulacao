...
n = 7683200  # Quantidade de amostras a serem geradas (Explicado no Relatório o calculo)
...
amostras_theta = np.random.dirichlet(parametros, n) ##substituir essa linhha pela função 
